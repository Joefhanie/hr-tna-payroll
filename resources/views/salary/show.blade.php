                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form method="POST" action="{{ route('salary.destroy', $salary) }}" class="inline" data-confirm="Are you sure you want to delete this salary record?" data-confirm-type="danger" data-confirm-text="Delete" data-confirm-title="Delete Salary Record">
                                            @csrf
                                            @method('DELETE')
