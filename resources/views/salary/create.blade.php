    ...
    <form method="POST" action="{{ route('salary.store', $employee) }}" class="rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div class="grid gap-6 sm:grid-cols-2">
            ...
            <div>
                ...
                <input type="number" id="daily_divisor" name="daily_divisor" step="0.01" min="0" value="{{ old('daily_divisor', '21.80') }}" class="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-800 placeholder-slate-400 transition focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20" placeholder="21.80">
