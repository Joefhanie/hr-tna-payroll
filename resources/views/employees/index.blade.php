<x-app-layout>
    ...
    <div class="mb-6 flex items-center gap-3">
        ...
        <a href="{{ route('reports.download', 'headcount') }}" class="inline-flex items-center gap-2 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 transition">
            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
