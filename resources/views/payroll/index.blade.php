                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('payroll.show', $payRun) }}" class="action-icon text-indigo-600 hover:text-indigo-800 transition" title="View">
                                    ...
                                    @if ($payRun->status == 1)
                                        <a href="{{ route('payroll.edit', $payRun) }}" class="action-icon text-slate-600 hover:text-slate-900 transition" title="Edit">
                                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
