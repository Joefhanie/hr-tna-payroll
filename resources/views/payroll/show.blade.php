<x-app-layout>
    ...
    <div id="payslipModal" class="hidden fixed inset-0 z-50 bg-black/40 p-4 overflow-y-auto justify-center items-start sm:items-center transition-opacity" style="padding-left: var(--sidebar-width);">
