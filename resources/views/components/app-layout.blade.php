...
<body class="min-h-screen overflow-x-hidden font-sans text-slate-900">
    @php
        $navGroups = [
            ...
            'Modules' => [
                ...
                ['route' => 'leave', 'path' => '/leave', 'label' => 'Leave', 'icon' => 'calendar-days'],
                ['route' => 'payroll.index', 'path' => '/payroll', 'label' => 'Payroll', 'icon' => 'money-bill-wave'],
                ['route' => 'benefits', 'path' => '/benefits', 'label' => 'Benefits', 'icon' => 'heart'],
                ['route' => 'self-service', 'path' => '/self-service', 'label' => 'Self-Service', 'icon' => 'circle-user'],
                ['route' => 'reports', 'path' => '/reports', 'label' => 'Reports', 'icon' => 'chart-column'],
            ],
        ];
    ...
    <div class="flex min-h-screen bg-transparent">
                        ...
                        @foreach ($items as $item)
                            ...
                            <a href="{{ $href }}" class="sidebar-link {{ $isActive ? 'sidebar-link-active' : '' }}">
                                <span class="inline-flex h-6 w-6 shrink-0 items-center justify-center">
                                    <i class="fa-solid fa-{{ $item['icon'] }} text-base"></i>
                                </span>
        ...
        <main class="main-content flex-1 overflow-y-auto transition-[padding-left] duration-300 ease-in-out">
            <header class="sticky top-0 z-20 border-b border-slate-200 bg-white/95 px-5 py-3.5 backdrop-blur-md sm:px-8">
                <div class="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex items-center gap-3 text-slate-500">
                        <span class="inline-flex h-7 w-7 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-500 shadow-sm">
