...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
        ...
        <input id="hire_date" name="hire_date" type="date" value="{{ old('hire_date', now()->toDateString()) }}" required 
            class="w-full rounded-xl border border-slate-200/70 bg-slate-50/50 px-4 py-3 text-sm text-slate-900 shadow-sm outline-none transition focus:border-indigo-600 focus:bg-white focus:ring-4 focus:ring-indigo-600/10">
    </div>
    ...
    <div>
        ...
        <div class="relative">
            <select id="position_id" name="position_id" 
                class="w-full appearance-none rounded-xl border border-slate-200/70 bg-slate-50/50 px-4 py-3 pr-10 text-sm text-slate-900 shadow-sm outline-none transition focus:border-indigo-600 focus:bg-white focus:ring-4 focus:ring-indigo-600/10 disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed">
...
<div class="flex items-center justify-between border-t border-slate-100 pt-6 mt-8">
    <a href="{{ route('register.profile') }}" class="rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">Back</a>
    <button type="submit" class="rounded-xl bg-indigo-600 px-6 py-3 text-sm font-semibold text-white shadow-md shadow-indigo-600/10 transition hover:-translate-y-0.5 hover:bg-indigo-700">Create account</button>
</div>
